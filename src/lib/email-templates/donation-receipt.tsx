      ...
      <Body style={{ backgroundColor: "#faf7f2", fontFamily: "Georgia, serif", margin: 0 }}>
        <Container style={{ padding: "32px", maxWidth: "560px" }}>
          ...
          <Text style={{ color: "#5a4630", fontSize: "15px", lineHeight: "24px" }}>
            Your gift keeps Svarga.ai free for people who cannot pay for it. This email is your
            receipt.
          </Text>
          ...
          <Text style={{ color: "#7a6a55", fontSize: "13px" }}>
            Svarga.ai — built in India by Aditya Mohan Menon. Questions? Reply to this email or
            write to adityamenon593@gmail.com.
          </Text>
        </Container>
      </Body>
    </Html>
